...
namespace RFID_CONTROLLER.Frm
{
    public partial class Map1F : Form
    {
        ...
        private void Map1F_Load(object sender, EventArgs e)
        {
            //게이트 아이콘 표시
            ...
            icons.Add("RFF1G01", new GateInfo(
                pictureBox1,
                FitWidthGap(Convert.ToInt32(pictureBox1.Size.Width * 84.5 / 100)),
                Convert.ToInt32(pictureBox1.Size.Height * 65 / 100)
                )
            );

            icons.Add("RFF1G02", new GateInfo(
                pictureBox1,
                FitWidthGap(Convert.ToInt32(pictureBox1.Size.Width * 78.5 / 100)),
                Convert.ToInt32(pictureBox1.Size.Height * 52 / 100)
                )
            );

            icons.Add("RFF1G03", new GateInfo(
                pictureBox1,
                FitWidthGap(Convert.ToInt32(pictureBox1.Size.Width * 86 / 100)),
            ...
            icons.Add("RFF1G04", new GateInfo(
                pictureBox1,
                FitWidthGap(Convert.ToInt32(pictureBox1.Size.Width * 78 / 100)),
                Convert.ToInt32(pictureBox1.Size.Height * 44.5 / 100)
                )
            );

            icons.Add("RFF1G05", new GateInfo(
                pictureBox1,
                FitWidthGap(Convert.ToInt32(pictureBox1.Size.Width * 65.5 / 100)),
                Convert.ToInt32(pictureBox1.Size.Height * 34 / 100)
                )
            );

            icons.Add("RFF1G06", new GateInfo(
                pictureBox1,
                FitWidthGap(Convert.ToInt32(pictureBox1.Size.Width * 62.5 / 100)),
                Convert.ToInt32(pictureBox1.Size.Height * 40 / 100)
                )
            );

            icons.Add("RFF1G07", new GateInfo(
                pictureBox1,
                FitWidthGap(Convert.ToInt32(pictureBox1.Size.Width * 61.5 / 100)),
                Convert.ToInt32(pictureBox1.Size.Height * 19 / 100)
                )
            );
            ...
            icons.Add("RFF1G08", new GateInfo(
                ...
                Convert.ToInt32(pictureBox1.Size.Height * 12 / 100)
                )
            );

            icons.Add("RFF1G09", new GateInfo(
                pictureBox1,
                FitWidthGap(Convert.ToInt32(pictureBox1.Size.Width * 43 / 100)),
                Convert.ToInt32(pictureBox1.Size.Height * 29.5 / 100)
                )
            );

            icons.Add("RFF1G10", new GateInfo(
                pictureBox1,
                FitWidthGap(Convert.ToInt32(pictureBox1.Size.Width * 39.3 / 100)),
                Convert.ToInt32(pictureBox1.Size.Height * 68 / 100)
                )
            );

            icons.Add("RFF1G11", new GateInfo(
                pictureBox1,
                FitWidthGap(Convert.ToInt32(pictureBox1.Size.Width * 41 / 100)),
            ...
            icons.Add("RFF1G12", new GateInfo(
                pictureBox1,
                FitWidthGap(Convert.ToInt32(pictureBox1.Size.Width * 30.5 / 100)),
                Convert.ToInt32(pictureBox1.Size.Height * 50 / 100)
                )
            );

            icons.Add("RFF1G13", new GateInfo(
                pictureBox1,
                FitWidthGap(Convert.ToInt32(pictureBox1.Size.Width * 70 / 100)),
                Convert.ToInt32(pictureBox1.Size.Height * 63 / 100)
                )
            );

            icons.Add("RFF1G14", new GateInfo(
                pictureBox1,
                FitWidthGap(Convert.ToInt32(pictureBox1.Size.Width * 18 / 100)),
                Convert.ToInt32(pictureBox1.Size.Height * 75 / 100)
                )
            );
        ...
        private void display()
        {
            ...
            if (rows != null)
            {
                for (int i = 0; i < rows.Count; i++)
                {
                    ...
                    if (icons.ContainsKey(key))
                    {
                        ...
                        if (gate != null)
                        {
                            ...
                            {
                                case "RFF1":
                                    if (row["STATUS"].ToString().Equals("NOR")) F1SttPanelBig.addNorCnt();
                                    else if (row["STATUS"].ToString().Equals("ERR")) F1SttPanelBig.addErrCnt();
                                    else if (row["STATUS"].ToString().Equals("IN")) F1SttPanelBig.addInCnt();
                                    else if (row["STATUS"].ToString().Equals("OUT")) F1SttPanelBig.addOutCnt();
                                    else F1SttPanelBig.addErrCnt();
                                    break;
                            }
                        }
                    }
                ...
                F1SttPanelBig.cntCheck();

                statusPanel1.norSttLabel = F1SttPanelBig.getNorCnt().ToString();
                statusPanel1.errSttLabel = F1SttPanelBig.getErrCnt().ToString();
                statusPanel1.inSttLabel = F1SttPanelBig.getInCnt().ToString();
                statusPanel1.outSttLabel = F1SttPanelBig.getOutCnt().ToString();

                F1SttPanelBig.resetAllCnt();
            }
        }
        ...
        private void Map1F_FormClosing(object sender, FormClosingEventArgs e)
        {
            thread.Abort();
            this.Dispose();
        }
