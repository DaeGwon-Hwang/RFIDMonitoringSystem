...
namespace RFID_CONTROLLER
{
    class Utils
    {
        ...
        /// 연계서버 IP 
        /// </summary>
        //public static string HOST_IP = "192.168.137.191";

        public static string HOST_IP = "10.10.20.11";
        /// <summary>
        /// 연계서버 Port no
        /// </summary>
        ...
        public static Dictionary<string, string> gateIdNameDic = new Dictionary<string, string>();
